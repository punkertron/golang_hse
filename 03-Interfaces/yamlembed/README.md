...
В этой задаче нужно познакомиться с [yaml'ем](https://pkg.go.dev/gopkg.in/yaml.v3) и (hopefully) кое-что понять про эмбеддинг.
...
* Флаги для yaml (omitempty, flow, inline) https://pkg.go.dev/gopkg.in/yaml.v3#Marshal
* Интерфейсы для переопределения функций [Marshal](https://pkg.go.dev/gopkg.in/yaml.v3#Marshaler) и [Unmarshal](https://pkg.go.dev/gopkg.in/yaml.v3#Unmarshaler)
