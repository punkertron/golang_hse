...
//go:generate mockgen -destination mock_test.go -package retryupdate_test gitlab.com/slon/shad-go/03-Interfaces/retryupdate/kvapi Client
...
import (
	...
	"gitlab.com/slon/shad-go/03-Interfaces/retryupdate"
