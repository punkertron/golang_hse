...
0. **(Один раз)** Зарегистрируйтесь в тестовой системе
   ...
   Перейдите в него по ссылке My Repo на https://app.manytask.org/hse-go-2025-fall/
...
2. **(Один раз)** Склонируйте ваш личный репозиторий
   ...
   git clone git@gitlab.manytask.org:hse/go/students-2025-fall/USERNAME.git .
   ```
...
8. Посмотрите как проходит тестирование, пройдя по ссылке My Submits со страницы https://app.manytask.org/hse-go-2025-fall/

9. Убедитесь, что ваша оценка появилась в [таблице](https://app.manytask.org/hse-go-2025-fall/database).
